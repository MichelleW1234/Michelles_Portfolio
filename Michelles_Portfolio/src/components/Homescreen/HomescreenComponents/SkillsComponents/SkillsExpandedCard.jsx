...
function SkillsExpandedCard({activeSkill, setActiveSkill}) {
  ...
  const skillApplications = [
    ...
    ["Utilized Agile practices to manage project development in sprints, coordinating tasks and tracking progress via GitHub (TritonTurnUp)", "Conducted user interviews during planning to inform feature design and improve engagement (TritonTurnUp)", "Built a production-ready desktop application, packaged and distributed via Electron Builder (various)"],
