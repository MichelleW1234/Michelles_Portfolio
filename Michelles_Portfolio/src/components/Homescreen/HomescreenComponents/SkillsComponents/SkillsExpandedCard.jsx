...
function SkillsExpandedCard({activeSkill, setActiveSkill}) {
  ...
  const skillApplications = [
    ["Used React's useState, useEffect, and useRef to manage game state and timing to bring animations to life (Arcade)", "Used local and session storage to persist user data and maintain progress between app sessions (various)", "Implemented functions and data structures in React to manage user interactions, dynamic state, and responsive UI features (various)"],
